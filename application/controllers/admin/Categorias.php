...
class Categorias extends CI_Controller {
    ...
    function index() {
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->smarty1->assign("categorias", $this->Categorias_model->get_todos());
            $this->smarty1->assign("title", 'Categorias');
            $this->smarty1->assign("class", "fa fa-shield");
            //Se carga el Template Users
            $this->smarty1->view('admin/categorias/categorias');
        }
    }
    ...
    function crear_categoria() {
        ...
        if ($this->form_validation->run() == TRUE) {
            $id_insertado = $this->Categorias_model->add();
            ...
            $this->smarty1->assign("class", "fa fa-shield");
            $this->smarty1->view('admin/categorias/crear_categoria');
        }
    }
    // edit a category
    function editar_categoria($id) {
        ...
        $categoria = $this->Categorias_model->get_by_id($id);
        if (empty($categoria)) {
            redirect('admin/categorias', 'refresh');
        }
        ...
        if (isset($_POST) && !empty($_POST)) {
            if ($this->form_validation->run() === TRUE) {
                $categoria_update = $this->Categorias_model->edit($id);
        ...
        $this->smarty1->assign("class", "fa fa-shield");
        $this->smarty1->view('admin/categorias/editar_categoria');
    }
    ...
    function borrar_categoria($id) {
        ...
        if ($this->input->post()) {
 		...
 		$categoria_delete = $this->Categorias_model->elim($id);
        ...
        $this->smarty1->assign("class", "fa fa-shield");
        $this->smarty1->view('admin/categorias/borrar_categoria');
    }
