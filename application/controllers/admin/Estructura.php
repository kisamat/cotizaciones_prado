...
class Estructura extends CI_Controller {
    ...
    function index() {
            ...
            $totalreg=$this->Items_model->total_registros(2);
            $this->smarty1->assign("listado", $this->listado);
            $this->smarty1->assign("data", $this->Items_model->listar_todos(2));
            $this->smarty1->assign("title", 'Items para eventos hotel el prado');
            $this->smarty1->assign("linkCrear","estructura/crear/".$this->idmenu );
            $this->smarty1->assign("linkEditar","estructura/editar/".$this->idmenu  );
            $this->smarty1->assign("linkEliminar","estructura/borrar/".$this->idmenu  );   
    ...
    function crear() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($id_insertado) {
                ...
                redirect("admin/estructura/index/".$this->idmenu);
            }
        } else {
    ...
    function borrar() {
        ...
        if (!$iditem || empty($iditem) || !is_numeric($iditem)) {
            redirect('admin/estructura/index/'.$this->idmenu, 'refresh');
        }
